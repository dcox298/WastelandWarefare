...
export default class WastelandWarefareWebPart extends BaseClientSideWebPart<IWastelandWarefareWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IWastelandWarefareProps> = React.createElement(
      WastelandWarefare,
      {
